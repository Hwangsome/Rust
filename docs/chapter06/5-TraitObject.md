# 5. Trait Object：`dyn Trait` 与动态分派

> - **所属章节**：第 6 章 · Flexibility and Abstraction with Generics and Traits
> - **Cargo package**：`chapter06`
> - **运行方式**：`cargo run -p chapter06`
> - **代码位置**：`chapters/chapter06/src/topic_05_trait_objects.rs`
> - **Lab**：`chapters/chapter06/src/lab.rs`
> - **上一篇**：[4. Super Trait](./4-SuperTrait.md)
> - **下一篇**：[6. Derive 与 Marker Trait](./6-Derive与MarkerTrait.md)
