...
> - **代码位置**：`chapters/chapter06/src/topic_07_associated_types_in_traits.rs`
> - **Lab**：`chapters/chapter06/src/lab.rs`
> - **上一篇**：[6. Derive 与 Marker Trait](./6-Derive与MarkerTrait.md)
> - **下一篇**：[8. 关联类型 vs 泛型参数的取舍](./8-关联类型与泛型参数的取舍.md)
